...
namespace AnuncieCompre.Migrations
{
    ...
    [Migration("20260517164906_InitialMigration")]
            ...
            modelBuilder.Entity("AnuncieCompre.Domain.Aggregates.UserAggregate.Vendor", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Name", "AnuncieCompre.Domain.Aggregates.UserAggregate.Vendor.Name#Name", b1 =>
                        {
                            b1.IsRequired();
